  ...
  Widget build(BuildContext context) {
    ...
    final mpinSegmentBaseDecoration = InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(
          color: AppzStyleConfig.instance.getStyleForState(AppzFieldState.focused).borderColor,
          width: AppzStyleConfig.instance.getStyleForState(AppzFieldState.focused).borderWidth,
        ),
      ),
    ...
    return Wrap(
      ...
      children: List.generate(widget.mpinLength, (index) {
        return SizedBox(
          width: 48,
          height: widget.currentStyle.height,
          child: TextFormField(
