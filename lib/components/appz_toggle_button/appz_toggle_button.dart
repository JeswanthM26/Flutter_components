...
class _AppzToggleButtonState extends State<AppzToggleButton> {
  ...
  Widget build(BuildContext context) {
    ...
    final sizeVariant =
        widget.size == AppzToggleButtonSize.small ? 'small' : 'large';
              ...
              child: Container(
                ...
                decoration: ShapeDecoration(
                  color: widget.isDisabled
                      ...
                      : (isSelected
                          ? config.getActiveColor()
                          : config.getInactiveColor()),
                  shape: RoundedRectangleBorder(
                    borderRadius:
                        BorderRadius.circular(config.getBorderRadius()),
                  ),
                ),
                child: AppzText(
                  ...
                  color: widget.isDisabled
                      ...
                      : (isSelected
                          ? config.getActiveTextColor()
                          : config.getInactiveTextColor()),
                ),
              ),
            );
          }),
